...
const Konten = () => {
    ...
    return (
        <>
            <Header2 />
            <div className='lg:px-40 z-10 -mt-3'> <Navbar activeItem={activeItem} setActiveItem={setActiveItem} /></div>
            <div className="px-4 sm:px-8 lg:px-40">
                <div className="text-2xl sm:text-3xl mt-10 lg:mt-0 lg:pt-8">Konten & Depots</div>
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-4 pt-5">
                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="flex flex-col items-center justify-center">
                            <span className="text-sm font-semibold">Krypto bald neu bei flatex!</span>
                            <span className="font-medium text-sm mx-1 text-gray-400">Jetzt Wartelisteplatz sichern.</span>
                        </div>
                    </div>
                    {/* Right Section */}
                ...
                <div className="mt-6 bg-white p-2 w-full overflow-x-auto sm:overflow-x-auto md:overflow-x-auto scroll-smooth">
                    ...
                    <div className="grid grid-cols-12 gap-4 text-xs mt-4 p-2 min-w-[1200px]">
                        <div className="col-span-7">***767 Cashkonto - Daniel Mehner</div>
                        <div className="col-span-2 text-end">
