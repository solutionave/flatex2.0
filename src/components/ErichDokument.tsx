...
const Dokumentdata = [
  {
    ...
    endDate: "10.09.2024",
    onButtonClick: () => {
      window.open("/docs/307_20210223_Kauf_Gazprom.pdf");
    },
  },
  {
    id: "307",
    ...
    endDate: "10.09.2024",
    onButtonClick: () => {
      window.open("/docs/307_20230908_Bankbestätigung");
    },
  },
];
...
const ErichDokument = () => {
  ...
  const [selectedAccount, setSelectedAccount] = useState("cashkonto");
  ...
  const Dokumentdata = [
    ...
    },
    {
      ...
      endDate: "10.09.2024",
      onButtonClick: () => {
        window.open("/docs/307_20230908_Bankbestätigung.pdf");
      },
    },
  ];

  // Filter documents based on selected account
  const filteredData =
