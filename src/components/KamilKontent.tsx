...
const accountData = [
  {
    name: "***634 Depot – Kamil Davleev",
    value: "123.664,75 EUR",
    available: "-",
    credit: "-",
    pledge: "65.027,82 EUR",
    accountNumber: "***634", // Added accountNumber
  },
  {
    name: "***493 Cashkonto – Kamil Davleev",
    value: "18.222,79 EUR",
    available: "18.222,79 EUR",
    credit: "0,00 EUR",
    pledge: "-",
    accountNumber: "***493", // Added accountNumber
  },
];
            ...
            {accountData.map((acc, index) => (
              ...
              >
                <div className="col-span-7">
                  <Link href={`/Depot?account=${acc.accountNumber}`}>
                    {acc.name}
                  </Link>
                </div>
                <div className="col-span-2 text-end">
